...
By default, baricoind will dump mempool on shutdown and
...
class MempoolPersistTest(BaricoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent baricoind from writing mempool.dat to disk. Verify that `savemempool` fails")
