...
class P2PPermissionsTests(BaricoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].baricoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].baricoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
