# Support for Output Descriptors in Baricoin Core

Since Baricoin Core v0.17, there is support for Output Descriptors. This is a
...
on Baricoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Baricoin Core wallets, a convenience function `combo` is
...
All RPCs in Baricoin Core will include the checksum in their output. Only
