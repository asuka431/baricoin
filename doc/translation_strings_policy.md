...
This document provides guidelines for internationalization of the Baricoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `baricoin_en.ts` remains unchanged.
