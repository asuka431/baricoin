...
#ifndef BARICOIN_INTERFACES_CHAIN_H
#define BARICOIN_INTERFACES_CHAIN_H
...
//! internal workings of the baricoin node, and not being very convenient to use.
...
#endif // BARICOIN_INTERFACES_CHAIN_H
