...
* [`Node`](node.h) — used by GUI to start & stop baricoin node. Added in [#10244](https://github.com/bitcoin/bitcoin/pull/10244).
...
The interfaces above define boundaries between major components of baricoin code (node, wallet, and gui), making it possible for them to run in different processes, and be tested, developed, and understood independently. These interfaces are not currently designed to be stable or to be used externally.
