...
#ifndef BARICOIN_TEST_SCRIPTNUM10_H
#define BARICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Baricoin Core 0.10.0, for cross-comparison.
 */
public:
