...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BaricoinAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_baricoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_baricoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_baricoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = BaricoinUnits::formatWithUnit(unit, balance, false, BaricoinUnits::separatorAlways);
    ...
    // Amount input
    BaricoinAmountField* amountInput = receiveCoinsDialog.findChild<BaricoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: baricoin:")) != -1);
