    ...
    platformStyle(_platformStyle)
{
    ...
    // normal baricoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying baricoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BaricoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
