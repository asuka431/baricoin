...
#ifndef BARICOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BARICOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@baricoin.
 *
 ...
 *
 * The chacha20-poly1305@baricoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@baricoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@baricoin are relatively fast in
...
#endif // BARICOIN_CRYPTO_CHACHA_POLY_AEAD_H
