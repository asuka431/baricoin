...
#ifndef BARICOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BARICOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Baricoin Core wallet was originally a collection of unrelated private
...
#endif // BARICOIN_WALLET_SCRIPTPUBKEYMAN_H
