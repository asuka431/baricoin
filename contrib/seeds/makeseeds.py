#!/usr/bin/env python3
# Copyright (c) 2013-2019 The Baricoin Core developers
...
def main():
    ...
    # Filter out hosts with multiple baricoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple baricoin ports' % (ip_stats(ips)), file=sys.stderr)
