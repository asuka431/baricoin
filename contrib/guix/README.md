# Bootstrappable Baricoin Core Builds

This directory contains the files necessary to perform bootstrappable Baricoin
Core builds.
...
- 24GB of free disk space on the partition that the Baricoin Core git repository
  resides in
...
For a Baricoin Core depends development environment, simply invoke
...
From the top of a clean Baricoin Core repository:
...
To use dongcarl's substitute server for Baricoin Core builds after having
